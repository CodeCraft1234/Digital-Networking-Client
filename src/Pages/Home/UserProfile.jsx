      ...
      <div className="flex flex-wrap justify-around p-5 gap-6">
        ...
        <div className="px-24 py-16 rounded-2xl bg-green-800 shadow-lg text-center text-white">
          ...
          <p className="text-2xl">
            ...
            <div className="mt-24 p-4 dark:text-green-800">
                <h6 className="text-center py-4 text-white uppercase font-bold text-3xl md:text-5xl bg-green-800">Own Work List</h6>
                <div className="flex ml-10 text-start justify-start items-center gap-3 mt-2">
<div>
<button className="font-avenir px-3  mx-auto py-1 bg-green-800 rounded-lg text-white" onClick={() => document.getElementById('my_modal_2').showModal()}>Add Campaign</button>
               ...
               <div>
               <h1 className="text-3xl my-4 text-center font-bold  text-gray-500">Add a Campaign </h1>
...
<div>
<button className="font-avenir px-3 mx-auto py-1 bg-green-800 rounded-lg text-white" onClick={() => document.getElementById('my_modal_1').showModal()}>Pay Now</button>
                    <dialog id="my_modal_1" className="modal">
                        <div className="modal-box">
                            <form onSubmit={(e) => handlePayment(e)}>
                               <div className="flex justify-center items-center gap-3">
                               <div className="mb-4">
                                    <label className="block text-gray-500">Previous Received</label>
                                    <input type="number" disabled name="previousReceived" defaultValue={totalPaymeent} className="w-full border rounded p-2 mt-1" />
                                </div>
                                <div className="mb-4">
                                    <label className="block text-gray-500">New Amount</label>
                                    <input type="number" name="amount" defaultValue={0} className="w-full border rounded p-2 mt-1" />
                                </div>
                               </div>
                                <div className="flex justify-center items-center gap-4">
                                    <div className="mb-4">
                                        <label className="block text-gray-500">Payment Method</label>
...
<div>
 <button onClick={handleRefresh} className="font-avenir px-3  mx-auto py-1 bg-green-800 rounded-lg text-white">Refresh</button>
</div>
</div>
                    ...
                    <table className="min-w-full bg-white">
                        ...
                        <tbody>
                            {dataa2.map((work, index) => (
                                <tr key={index} className={`${index % 2 === 0 ? "text-gray-500 border-b border-opacity-20 " : "text-gray-500 border-b border-opacity-20 "}`}>
                                        ...
                                        <dialog id={`modal_${index}`} className="modal">
                                            <div className="modal-box">
                                                <form onSubmit={(e) => handleUpdate(e, work._id)}>
                                                    ...
                                                    <button type="submit" className="font-avenir px-3 mx-auto py-1 bg-green-800 rounded-lg text-white">Update</button>
                                                </form>
                                                <div className="modal-action">

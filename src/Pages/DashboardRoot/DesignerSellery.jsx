...
const DesignersSellery = () => {
  ...
  const initialTab = localStorage.getItem("activeTabsummeryEmployeedSsd") || "allEmployee";
  ...
  const changeTab = (tab) => {
    ...
    localStorage.setItem("activeTabsummeryEmployeedSsd", tab); 
  };
  ...
  return (
    <div className='m-5'>
         <Helmet>
        <title>Designers Salary | Digital Network </title>

  ...
  const handlePayment = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://digital-networking-server.vercel.app/users/${paymentMethod}/${userdata._id}`,
        body2
      );
    ...
    <div>
     ...
     <p className="balance-card-text text-lg lg:text-2xl font-bold text-gray-700"><span className="text-lg lg:text-2xl font-extrabold">Bank Cashout : ৳</span> {bankTotal2}</p> */}
      ...
      <div className="flex mt-5 justify-between items-center gap-5   ">
        <div className="">
          <button
            className="font-avenir px-6 mt-7 mx-auto py-2 bg-[#05a0db] ml-5 rounded-lg text-white"
          ...
          <dialog id="my_modal_1" className="modal">
            <div className="modal-box bg-white text-black font-bold">
              <form onSubmit={(e) => handlePayment(e)}>
                ...
                <div className="grid mt-8 grid-cols-2 gap-3"></div>
                <button
                  type="submit"
        ...
        <div className="flex  justify-end items-center gap-5  ml-2 ">
          ...
          <div className="mt-6 flex justify-right items-right">
            <input
              type="text"
      ...
      <div className="overflow-x-auto mt-6 mx-4 rounded">

...
const EmployeerSellery = () => {
    ...
    useEffect(() => {
      const filtered = users.find(e => e.email === email);
    ...
    const calculateTotalSelleryAndBonus = (month) => {
        ...
        sellery.forEach(s => {
            ...
            if (selleryMonth === month && s.email === email) {
    ...
    return (
        <div className='m-5'>
            {/* <h1 className='text-3xl font-bold text-black text-center mb-5'>{currentUser.name}</h1> */}

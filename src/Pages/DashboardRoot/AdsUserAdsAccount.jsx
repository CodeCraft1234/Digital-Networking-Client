...
const AdsUserAdsAccount = () => {
  ...
  const handlePayment =async (e) => {
    ...
    AxiosPublic.post(
      "https://hishab-202555.vercel.app/adsPayment",
      data
    )
      .then((res) => {
        refetch();
      ...
      try {
        const res = await axios.put(`https://hishab-202555.vercel.app/users/${paymentMethod}/${userdata._id}`, body2);
        console.log(res.data);
 ...
 const [data,setData]=useState([])
  console.log(data)
    ...
    useEffect(()=>{
      AxiosPublic.get(`https://hishab-202555.vercel.app/users/${userr?.email}`)
      .then(res=>{
        console.log(res.data)
        setData(res.data)
      })
    ...
    const handleUpdateTotalSpent = (e, id,  accountName, employeeEmail, employeeName) => {
      ...
      axios.put(`https://hishab-202555.vercel.app/adsAccountCenter/totalSpent/${id}`, body)
        .then((res) => {
          console.log(res.data);
          refetch();
